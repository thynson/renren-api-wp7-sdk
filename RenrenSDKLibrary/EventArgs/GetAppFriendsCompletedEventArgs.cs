...
{
    public class GetAppFriendsCompletedEventArgs : EventArgs
    {
        #region Properties
        /// <summary>
        /// Gets the data that is downloaded by a DownloadStringAsync method.
        /// </summary>
        public ObservableCollection<AppFriend> Result { get; private set; }
        ...
        public GetAppFriendsCompletedEventArgs(ObservableCollection<AppFriend> result)
        {
            Result = result;
        }
        ...
        public GetAppFriendsCompletedEventArgs(Exception ex)
        {
            Error = ex;
        }
