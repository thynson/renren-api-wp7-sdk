...
{
    public class GetFriendsCompletedEventArgs : EventArgs
    {
        #region Properties
        /// <summary>
        /// Gets the data that is downloaded by a DownloadStringAsync method.
        /// </summary>
        public ObservableCollection<Friend> Result { get; private set; }
        ...
        public GetFriendsCompletedEventArgs(ObservableCollection<Friend> result)
        {
            Result = result;
        }
        ...
        public GetFriendsCompletedEventArgs(Exception ex)
        {
            Error = ex;
        }
