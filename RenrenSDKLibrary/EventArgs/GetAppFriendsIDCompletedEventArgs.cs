...
{
    public class GetAppFriendsIDCompletedEventArgs : EventArgs
    {
        #region Properties
        /// <summary>
        ...
        public GetAppFriendsIDCompletedEventArgs(ObservableCollection<int> result)
        {
            Result = result;
        }
        ...
        public GetAppFriendsIDCompletedEventArgs(Exception ex)
        {
            Error = ex;
        }
