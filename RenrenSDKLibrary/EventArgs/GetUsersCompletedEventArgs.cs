...
{
    public class GetUsersCompletedEventArgs:EventArgs
    {
         #region Properties
        ...
        /// </summary>
        public UserList Result { get; private set; }
        ...
        public GetUsersCompletedEventArgs(UserList result)
        {
            Result = result;
        }
        ...
        public GetUsersCompletedEventArgs(Exception ex)
        {
            Error = ex;
        }
